        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
          <div className='card'>
            <div className='p-5 flex flex-col'>
              ...
              <Image src="/dahlia.png" alt="Dahlia"  width={500} height={500}  />
            </div>
          ...
          <div className='card'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
              <Image src="/rose.jpg" alt="Rose" width={500} height={500} />
            </div>
          ...
          <div className='card'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
              <Image src="/jasmine2.png" alt="Jasmine"  width={500} height={500}  />
            </div>
          ...
          <div className='card'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
              <Image src="/lilly.png" alt="Lilly"  width={500} height={500}  />
            </div>
          ...
          <div className='card'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
              <Image src="/mari.png" alt='MariGold'  width={500} height={500}   />
              </div>
          ...
          <div className='card'>
            <div className='p-5 flex flex-col'>
              <div className='rounded-xl overflow-hidden'>
              <Image src="/sunflower.png" alt="Sunflower"  width={500} height={500} />
            </div>
